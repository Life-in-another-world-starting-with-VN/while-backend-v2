...
가장 중요!!!
- 진행 상황 : {time_progress}
- 위에 진행 상황 값이 100을 넘어가고 지금까지의 스토리중 고백하고 답변을 받았다면 무조건 '끝'을 반환하세요!!
...
- 시간 준수를 꼭 준수하세요!!!
- 그리고 고백과 답변이 끝나면 2, 3개의 씬 이내에 끝내고 그 이후에는 '끝' 이라는 대사만 반환하세요
...
5. **장소 변경 - 적극 활용**:
   ...
   - 장소는 대화에 맞게끔 제작
   - 같은 장소에서 계속 대화하는 경우 절대 장소 변경 금지
   - 장소 변경이 필요한 경우에만 session_ended=true로 설정
